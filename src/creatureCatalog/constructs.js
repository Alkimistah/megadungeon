export const gargoyle = {
    ...
    actions: [
        { name: "Duas garras", text: "Corpo a Corpo Duas garras +12 (1d6+6)." }
    ],
    abilities: [
        {
            name: "Imobilidade",
...
export const golemDeHierro = {
    ...
    stats: {
        ...
        hitPoints: 400, speedText: "9m (6q)",
        senses: null, defensesText: null,
        attributes: { str: 12, dex: -1, con: 10, int: null, wis: 0, cha: -5 }
    },
    actions: [{ name: null, text: "Corpo a Corpo Duas pancadas +30 (2d10+25)." }],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
    skillsText: null
...
export const colossoSupremo = {
    ...
    stats: {
        ...
        hitPoints: 675, speedText: "12m (8q)",
        senses: null, defensesText: null,
        attributes: { str: 15, dex: -1, con: 10, int: null, wis: -5, cha: -5 }
    },
    actions: [{ name: null, text: "Corpo a Corpo Espada titânica +39 (4d12+30, 19)." }],
    abilities: [],
    equipment: null,
...
export const engenhoDeGuerraGoblin = {
    ...
    stats: {
        ...
        hitPoints: 246, speedText: "12m (8q)",
        senses: null, defensesText: null,
...
// ─── Construtos de Ameaças de Arton ───────────────────────────────────────────
...
export const gargulaAssassina = {
    ...
    stats: {
        ...
        hitPoints: 140, speedText: "12m (8q), voo 18m (12q)",
        senses: "visão no escuro",
        defensesText: "imunidade a petrificado, redução de dano 5",
        attributes: { str: 6, dex: 2, con: 4, int: -2, wis: 1, cha: -2 }
    },
    actions: [
        { name: "Duas garras", text: "Corpo a Corpo Duas garras +17 (2d6+10)." },
...
export const soldadoMecanico = {
    ...
    stats: {
        ...
        hitPoints: 23, speedText: "6m (4q)",
        senses: "visão no escuro",
        defensesText: "imunidade a fogo",
        attributes: { str: 4, dex: -1, con: 3, int: null, wis: 0, cha: -5 }
    },
    actions: [
        { name: "Lança", text: "Corpo a Corpo Lança x2 +16 (1d8+8)." },
        { name: "Besta pesada", text: "À Distância Besta pesada +11 (1d12+10, 19)." },
...
export const espadaDaFloresta = {
    ...
    stats: {
        ...
        hitPoints: 108, speedText: "9m (6q)",
        senses: "visão no escuro",
        defensesText: "natureza vegetal, vulnerabilidade a fogo",
        attributes: { str: 6, dex: 3, con: 4, int: -2, wis: 2, cha: 0 }
    },
    actions: [
        { name: "Espada espinhenta", text: "Corpo a Corpo Espada espinhenta +14 (1d12+15 corte, 19)." }
    ],
    abilities: [
...
export const galhadaMacho = {
    ...
    actions: [
        { name: "Chifres e cascos", text: "Corpo a Corpo Chifres +12 (1d6+7) e cascos +12 (1d6+7)." }
    ],
    abilities: [
...
export const galhadaFemea = {
    ...
    actions: [
        { name: "Cascos", text: "Corpo a Corpo Cascos +14 (2d6+10)." }
    ],
    abilities: [
