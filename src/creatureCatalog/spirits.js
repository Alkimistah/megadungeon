export const hellHound = {
    ...
    source: null,
    stats: {
        initiative: 6, perception: 4, defense: 21, fortitude: 11, reflex: 9, will: 7,
        hitPoints: 95,
        speedText: "12m (8q)",
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +14 (2d6+6 mais 2d6 fogo)." }
    ],
    abilities: [
        { name: "Sopro", timing: "padrão", text: "O cão do inferno cospe fogo em um cone de 6m. Criaturas na área sofrem 4d6+4 pontos de dano de fogo (Ref CD 17 reduz à metade). Recarrega como movimento." }
    ],
    equipment: null,
...
export const aquinne = {
    ...
    source: null,
    stats: {
        initiative: 4, perception: 4, defense: 18, fortitude: 10, reflex: 7, will: 3,
        hitPoints: 21,
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Tentáculo hídrico +13 (2d4+6 corte)." }
    ],
    abilities: [
        { name: "Afogar", timing: "passiva", text: "Uma criatura agarrada pelo aquin'ne é considerada submersa até se soltar." },
        { name: "Agarrar Aprimorado", timing: "livre", text: "Após acertar Tentáculo hídrico, faz teste +13 para agarrar." },
        { name: "Redemoinho de Maresia", timing: "padrão", text: "O aquin'ne toca um objeto adjacente, que perde 5 PV (Ref CD 16 evita)." },
        { name: "Familiar Umariquim", timing: "passiva", text: "Aquin'ne familiar concede deslocamento de natação 9m e permite lançar magias e respirar debaixo d'água." }
    ],
    equipment: null,
...
export const terrier = {
    ...
    source: null,
    stats: {
        initiative: 0, perception: 3, defense: 16, fortitude: 11, reflex: 0, will: 5,
        hitPoints: 35,
        speedText: "6m (4q)",
        senses: "visão no escuro",
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Pancada +9 (2d6+8)." }
    ],
    abilities: [
        { name: "Pedra-Punho", timing: "padrão", text: "O terrier dispara pedras do tamanho de um punho humano em criaturas a sua escolha em alcance curto. Cada criatura sofre 1d6+4 pontos de dano de impacto e fica atordoada por 1 rodada (Fort CD 16 reduz à metade e evita a condição). Uma criatura que passe no teste de resistência não pode mais ser atordoada por esta habilidade até o fim da cena. Recarrega como movimento." },
        { name: "Pedregoso", timing: "passiva", text: "Um terrier pode permanecer completamente imóvel. Se ele estiver assim, um personagem deve passar em um teste de Percepção CD 30 para perceber que ele é uma criatura e não um monte de pedras." },
        { name: "Familiar Granito", timing: "passiva", text: "Um terrier familiar concede redução de dano 2/impacto." }
    ],
    equipment: null,
...
export const pamgra = {
    ...
    source: null,
    stats: {
        initiative: 7, perception: 6, defense: 31, fortitude: 20, reflex: 14, will: 7,
        hitPoints: 280,
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Duas pancadas +24 (2d10+15, 19)." }
    ],
    abilities: [
        { name: "Cristalário", timing: "passiva", text: "Os cristais afiados do corpo do pamgra ferem profundamente suas vítimas. Criaturas atingidas por ataques do pamgra ficam sangrando (Fort CD 26 evita)." },
        { name: "Golpe Avassalador", timing: "livre", text: "Quando acerta um ataque de pancada, o pamgra arremessa a vítima 1d6 x 1,5m em uma direção à escolha dele (Fort CD 24 evita). A vítima fica caída e, se atingir algum obstáculo, sofre 1d6 pontos de dano de impacto para cada 1,5m que foi arremessada." }
    ],
    equipment: null,
...
export const guerreiroDeCHifres = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Machado de guerra +14 (1d12+16, x3) ou lança +14 (1d6+7)." }
    ],
    abilities: [],
...
export const corgann = {
    ...
    stats: {
        ...
        hitPoints: 61,
        speedText: "9m (6q), natação 15m",
        senses: null,
        defensesText: null,
        attributes: { str: 2, dex: 6, con: 3, int: -2, wis: 2, cha: -1 }
    },
    actions: [
        { name: "À Distância", text: "Jato d'água x2 +27 (2d8+29)." }
    ],
    abilities: [],
    equipment: null,
...
export const namasqall = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Quatro tentáculos d'água +39 (2d10+30)." }
    ],
    abilities: [],
    equipment: null,
...
export const tPeel = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Brisa agressiva +11 (2d4+9 corte)." },
        { name: "À Distância", text: "Lufada cortante +11 (2d4+9 corte, alcance curto)." }
    ],
    abilities: [],
    equipment: null,
...
export const rarvnaak = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Dois socos pneumáticos +20 (1d8+16)." }
    ],
    abilities: [],
    equipment: null,
...
export const hallusTir = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Punho x3 +44 (2d12+23 impacto)." },
        { name: "À Distância", text: "Dois escombros +37 (4d6+31 impacto, x3, alcance médio)." }
    ],
    abilities: [],
    equipment: null,
...
export const pakk = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Queima (consultar livro)." }
    ],
    abilities: [],
    equipment: null,
...
export const berBaram = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Marrada +26 (2d10+12 mais 3d6 fogo)." }
    ],
    abilities: [],
    equipment: null,
...
export const serpentaar = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida x2 +39 (2d10+7 mais 6d6+31 fogo)." }
    ],
    abilities: [],
    equipment: null,
...
export const bandoDePamgras = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "[Bando] Duas pancadas +34 (4d10+30, 19)." }
    ],
    abilities: [],
    equipment: null,
...
export const tanaloom = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Duas pancadas +37 (4d12+49)." },
        { name: "À Distância", text: "Flechas ácidas x6 +34 (3d6+10 ácido, x3, alcance médio)." }
    ],
    abilities: [],
    equipment: null,
...
export const elementalCorrompido = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +46 (3d12+15 mais 4d6 ácido)." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
...
export const oni = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Machado de guerra +17 (1d12+16, x3)." }
    ],
    abilities: [],
