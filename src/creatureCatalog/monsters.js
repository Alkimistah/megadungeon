...
export const glooop = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Pancada +12 (2d6+3 mais 2d6 ácido)." }
    ],
    abilities: [
...
export const mamaeGlop = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Pancada +12 (2d6+2 mais 2d6 ácido)." }
    ],
    abilities: [
...
export const cockatrice = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Bicada +14 (2d4+8 perfuração)." }
    ],
    abilities: [
...
export const basilisk = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +16 (2d8+12 mais veneno)." }
    ],
    abilities: [
...
export const bulette = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +23 (3d8+24 mais 4d6 ácido)." }
    ],
    abilities: [
...
export const tendriculo = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +20 (2d6+10 mais veneno)." },
        { name: "Corpo a Corpo", text: "Dois tentáculos +24 (4d4+5)." }
    ],
    abilities: [
...
export const aranhaGigante = {
    ...
    stats: {
        initiative: 7, perception: 3, defense: 19, fortitude: 8, reflex: 11, will: 3,
        hitPoints: 77,
        speedText: "12m (8q), escalar 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: 5, dex: 4, con: 1, int: -5, wis: 0, cha: -4 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +12 (2d6+8 mais veneno)." }
    ],
    abilities: [
...
export const manticora = {
    ...
    source: { book: "Livro Básico", pdfPage: 2, bookPage: null },
    stats: {
        initiative: 7, perception: 8, defense: 26, fortitude: 18, reflex: 7, will: 12,
        hitPoints: 240,
        speedText: "9m (6q), voo 15m (10q)",
        senses: null,
        defensesText: null,
        attributes: { str: 7, dex: 2, con: 5, int: -2, wis: 1, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +18 (1d10+12) e duas garras +18 (1d8+12)." }
    ],
    abilities: [],
    equipment: null,
...
export const centopeiasDragao = {
    ...
    source: { book: "Livro Básico", pdfPage: 2, bookPage: null },
    stats: {
        initiative: 10, perception: 8, defense: 27, fortitude: 20, reflex: 14, will: 9,
        hitPoints: 275,
        speedText: "15m (10q), escavar 6m (4q)",
        senses: null,
        defensesText: null,
        attributes: { str: 11, dex: 3, con: 9, int: -4, wis: 1, cha: 0 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +24 (2d8+18 mais 2d6 de fogo)." }
    ],
    abilities: [],
    equipment: null,
...
export const grifo = {
    ...
    challengeRating: 3,
    description: [],
    source: { book: "Livro Básico", pdfPage: 7, bookPage: null },
    stats: {
        initiative: 9, perception: 7, defense: 19, fortitude: 9, reflex: 15, will: 4,
        hitPoints: 110,
        speedText: "12m, voo 24m",
        senses: null,
        defensesText: null,
        attributes: { str: 5, dex: 4, con: 3, int: -4, wis: 2, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +14 (2d6+5) e duas garras +14." }
    ],
    abilities: [],
    equipment: null,
...
export const ursoCoruja = {
    ...
    challengeRating: 4,
    description: [],
    source: { book: "Livro Básico", pdfPage: 8, bookPage: null },
    stats: {
        initiative: 7, perception: 5, defense: 23, fortitude: 16, reflex: 10, will: 5,
        hitPoints: 145,
        speedText: "12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: 7, dex: 3, con: 5, int: -4, wis: 1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +16 (1d8+5) e duas garras +15." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
...
export const serpe = {
    ...
    source: { book: "Livro Básico", pdfPage: 8, bookPage: null },
    stats: {
        initiative: 5, perception: 7, defense: 24, fortitude: 10, reflex: 16, will: 5,
        hitPoints: 200,
        speedText: "9m (6q), voo 18m (12q)",
        senses: null,
        defensesText: null,
        attributes: { str: 6, dex: 1, con: 6, int: -2, wis: 1, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +17 (2d6+12) e ferrão +17 (1d8+12)." }
    ],
    abilities: [],
    equipment: null,
...
export const hidra = {
    ...
    challengeRating: 11,
    description: [],
    source: { book: "Livro Básico", pdfPage: 21, bookPage: null },
    stats: {
        initiative: 9, perception: 9, defense: 35, fortitude: 24, reflex: 18, will: 9,
        hitPoints: 550,
        speedText: "9m (6q), natação 9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 10, dex: 0, con: 10, int: -4, wis: 0, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Cinco mordidas +34 (3d6+16)." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Padrão.",
...
export const lagash = {
    ...
    source: { book: "Livro Básico", pdfPage: 21, bookPage: null },
    stats: {
        initiative: 19, perception: 11, defense: 41, fortitude: 26, reflex: 20, will: 13,
        hitPoints: 660,
        speedText: "12m (8q), escalar 12m (8q), natação 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: 11, dex: 4, con: 9, int: -3, wis: 2, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +37 (4d12+28 mais veneno)." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Padrão.",
...
export const ganchador = {
    ...
    challengeRating: 5,
    description: [],
    source: { book: "Livro Básico", pdfPage: 23, bookPage: null },
    stats: {
        initiative: 7, perception: 5, defense: 26, fortitude: 15, reflex: 11, will: 7,
        hitPoints: 210,
        speedText: "9m (6q), escalar 9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 6, dex: 3, con: 5, int: -2, wis: 1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +17 (2d6+8) e duas garras +17." }
    ],
    abilities: [],
    equipment: null,
...
export const troll = {
    ...
    source: { book: "Livro Básico", pdfPage: 23, bookPage: null },
    stats: {
        initiative: 4, perception: 3, defense: 23, fortitude: 14, reflex: 10, will: 6,
        hitPoints: 165,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 6, dex: 2, con: 6, int: -2, wis: -1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +17 (1d8+6) e duas garras +17." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Padrão.",
...
export const trollDasCavernas = {
    ...
    challengeRating: 9,
    description: [],
    source: { book: "Livro Básico", pdfPage: 24, bookPage: null },
    stats: {
        initiative: 7, perception: 14, defense: 29, fortitude: 21, reflex: 15, will: 9,
        hitPoints: 345,
        speedText: "12m (8q), escalar 9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 9, dex: 0, con: 11, int: -2, wis: -1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Tacape +26 (3d6+27) e mordida +26." }
    ],
    abilities: [],
...
export const dragaoFilhote = {
    ...
    challengeRating: 3,
    description: [],
    source: { book: "Livro Básico", pdfPage: 25, bookPage: null },
    stats: {
        initiative: 8, perception: 5, defense: 22, fortitude: 15, reflex: 3, will: 9,
        hitPoints: 140,
        speedText: "12m (8q), voo 18m (12q)",
        senses: null,
        defensesText: null,
        attributes: { str: 4, dex: 3, con: 3, int: 0, wis: 0, cha: 0 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +15 (2d6+5) e duas garras +15." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Padrão.",
...
export const dragaoJovem = {
    ...
    source: { book: "Livro Básico", pdfPage: 25, bookPage: null },
    stats: {
        initiative: 11, perception: 11, defense: 32, fortitude: 20, reflex: 9, will: 12,
        hitPoints: 320,
        speedText: "12m (8q), voo 18m (12q)",
        senses: null,
        defensesText: null,
        attributes: { str: 7, dex: 2, con: 6, int: 2, wis: 2, cha: 2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +25 (2d6+14, 19) e duas garras." }
    ],
    abilities: [],
    equipment: null,
...
export const dragaoAdulto = {
    ...
    challengeRating: 11,
    description: [],
    source: { book: "Livro Básico", pdfPage: 26, bookPage: null },
    stats: {
        initiative: 12, perception: 15, defense: 42, fortitude: 24, reflex: 11, will: 18,
        hitPoints: 600,
        speedText: "12m (8q), voo 24m (16q)",
        senses: null,
        defensesText: null,
        attributes: { str: 11, dex: 1, con: 8, int: 4, wis: 4, cha: 4 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +35 (4d10+25, 18) e duas garras." }
    ],
    abilities: [],
    equipment: null,
...
export const dragaoVeneravel = {
    ...
    source: { book: "Livro Básico", pdfPage: 26, bookPage: null },
    stats: {
        initiative: 16, perception: 22, defense: 52, fortitude: 28, reflex: 15, will: 22,
        hitPoints: 800,
        speedText: "12m (8q), voo 24m (16q)",
        senses: null,
        defensesText: null,
        attributes: { str: 13, dex: 1, con: 10, int: 6, wis: 6, cha: 6 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +44 (4d12+40, 17) e duas garras." }
    ],
    abilities: [],
    equipment: null,
...
export const dragaoRei = {
    ...
    challengeRating: 20,
    description: [],
    source: { book: "Livro Básico", pdfPage: 27, bookPage: null },
    stats: {
        initiative: 19, perception: 27, defense: 62, fortitude: 34, reflex: 20, will: 28,
        hitPoints: 1400,
        speedText: "12m (8q), voo 36m (24q)",
        senses: null,
        defensesText: null,
        attributes: { str: 17, dex: 0, con: 12, int: 7, wis: 7, cha: 7 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Mordida +55 (6d20+50, 16) e duas garras." }
    ],
    abilities: [],
    equipment: null,
...
export const uktril = {
    ...
    challengeRating: 3,
    description: [],
    source: { book: "Livro Básico", pdfPage: 29, bookPage: null },
    stats: {
        initiative: 9, perception: 10, defense: 22, fortitude: 12, reflex: 11, will: 6,
        hitPoints: 45,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 5, dex: 4, con: 2, int: -1, wis: 2, cha: -4 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Pinça +16 (2d6+6, 19) e garra +16 (1d6+6)." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
...
export const geraktril = {
    ...
    source: { book: "Livro Básico", pdfPage: 29, bookPage: null },
    stats: {
        initiative: 13, perception: 16, defense: 30, fortitude: 18, reflex: 15, will: 6,
        hitPoints: 240,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 7, dex: 5, con: 3, int: 1, wis: 3, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Duas pinças +23 (3d6+10, 19) e garra +23." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
...
export const reishid = {
    ...
    source: { book: "Livro Básico", pdfPage: 29, bookPage: null },
    stats: {
        initiative: null, perception: null, defense: null, fortitude: null, reflex: null, will: null,
        hitPoints: null,
        speedText: null,
        senses: null,
        defensesText: null,
...
export const otyugh = {
    ...
    challengeRating: 5,
    description: [],
    source: { book: "Livro Básico", pdfPage: 30, bookPage: null },
    stats: {
        initiative: 3, perception: 10, defense: 24, fortitude: 17, reflex: 11, will: 5,
        hitPoints: 213,
        speedText: "6m (4q)",
        senses: null,
        defensesText: null,
        attributes: { str: 4, dex: 7, con: 4, int: 4, wis: 4, cha: 1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Dois tentáculos +17 (1d8+9, alcance 4,5m)." },
        { name: "Corpo a Corpo", text: "Adaga da Tormenta +30 (1d4+18 mais)." },
        { name: "Corpo a Corpo", text: "Quatro pancadas +48 (4d12+24)." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Padrão.",
...
export const carrascoDeLeena = {
    ...
    stats: {
        initiative: 6, perception: 6, defense: 27, fortitude: 16, reflex: 12, will: 8,
        hitPoints: 180,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 5, dex: 1, con: 4, int: -4, wis: 1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Tentáculo +20 (2d6+10 corte) e mordida +20." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Nenhum.",
...
export const ente = {
    ...
    stats: {
        initiative: 7, perception: 11, defense: 34, fortitude: 21, reflex: 8, will: 15,
        hitPoints: 310,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 9, dex: -1, con: 5, int: 1, wis: 3, cha: 1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Duas pancadas +26 (4d8+16)." }
    ],
    abilities: [],
    equipment: null,
...
export const estirge = {
    ...
    stats: {
        initiative: 7, perception: 2, defense: 16, fortitude: 1, reflex: 10, will: 5,
        hitPoints: 9,
        speedText: "voo 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: -4, dex: 5, con: -1, int: -5, wis: 0, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Probóscide +11 (1 perfuração)." }
    ],
    abilities: [],
    equipment: null,
...
export const enxameEstirge = {
    ...
    stats: {
        initiative: 9, perception: 4, defense: 23, fortitude: 6, reflex: 16, will: 11,
        hitPoints: 40,
        speedText: "voo 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: -3, dex: 5, con: -1, int: -5, wis: 0, cha: -2 }
    },
    actions: [
        { name: "Enxame", text: "1d6 pontos de dano de perfuração. Para cada ponto." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Ova de estirge.",
...
export const nuvemDeEstirges = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "elementais e ermos.pdf", pdfPage: 21, bookPage: 108 },
    stats: {
        initiative: 19, perception: 14, defense: 51, fortitude: 17, reflex: 29, will: 24,
        hitPoints: 180,
        speedText: "voo 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: -2, dex: 5, con: -1, int: -5, wis: 0, cha: -2 }
    },
    actions: [
        { name: "Enxame", text: "10d6 pontos de dano de perfuração. Para cada ponto." }
    ],
    abilities: [],
    equipment: null,
    treasure: "Ova de estirge.",
...
export const feraVassalo = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "elementais e ermos.pdf", pdfPage: 21, bookPage: 108 },
    stats: {
        initiative: 3, perception: 3, defense: 21, fortitude: 10, reflex: 13, will: 4,
        hitPoints: 22,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 4, dex: 0, con: 3, int: -2, wis: 0, cha: -3 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Duas garras +15 (2d6+6)." },
        { name: "À Distância", text: "Dois espinhos +15 (2d6+3 perfuração, alcance)." }
    ],
    abilities: [],
    equipment: null,
...
export const feraLider = {
    ...
    stats: {
        initiative: 4, perception: 4, defense: 25, fortitude: 12, reflex: 16, will: 5,
        hitPoints: 195,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 5, dex: 0, con: 4, int: -2, wis: 0, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Duas garras +16 (2d6+12)." },
        { name: "À Distância", text: "Dois espinhos +16 (2d6+6 perfuração, alcance)." }
    ],
    abilities: [],
    equipment: null,
...
export const feraMae = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "elementais e ermos.pdf", pdfPage: 22, bookPage: 109 },
    stats: {
        initiative: 7, perception: 24, defense: 45, fortitude: 28, reflex: 8, will: 23,
        hitPoints: 685,
        speedText: "0m (0q)",
        senses: null,
        defensesText: null,
        attributes: { str: 8, dex: -3, con: 8, int: 2, wis: 4, cha: -2 }
    },
    actions: [],
    abilities: [],
    equipment: null,
...
export const enxameLarval = {
    ...
    stats: {
        ...
        senses: null,
        defensesText: null,
        attributes: { str: -1, dex: 2, con: 0, int: -4, wis: -1, cha: -3 }
    },
    actions: [
...
export const koboldPatrulheiro = {
    ...
    stats: {
        initiative: 4, perception: 0, defense: 14, fortitude: 3, reflex: 5, will: 0,
        hitPoints: 6,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 1, dex: 2, con: 0, int: -1, wis: 0, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Lança +9 (1d6+1)." },
        { name: "À Distância", text: "Funda +9 (1d4+6)." }
    ],
    abilities: [],
...
export const koboldVeterano = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "ameacas de arton variadas.pdf", pdfPage: 5, bookPage: 181 },
    stats: {
        initiative: 5, perception: 1, defense: 19, fortitude: 7, reflex: 12, will: 3,
        hitPoints: 13,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Lança +14 x2 (1d6+6)." },
        { name: "À Distância", text: "Funda +14 (2d4+12)." }
    ],
    abilities: [],
...
export const patrulhaKobold = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "ameacas de arton variadas.pdf", pdfPage: 5, bookPage: 181 },
    stats: {
        initiative: 6, perception: 2, defense: 23, fortitude: 10, reflex: 15, will: 5,
        hitPoints: 30,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
    ...
    actions: [
        { name: "Corpo a Corpo", text: "[Bando] Lança +17 (1d6+1)." },
        { name: "À Distância", text: "[Bando] Funda +17 (1d4+6)." }
    ],
    abilities: [],
    equipment: "Funda, lança, pedras x20.",
    treasure: "Metade.",
...
export const koboldExplosivo = {
    ...
    stats: {
        initiative: 4, perception: 0, defense: 15, fortitude: 5, reflex: 10, will: 1,
        hitPoints: 9,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Lança +11 (1d6+9)." },
        { name: "À Distância", text: "Funda +11 (1d4+9)." }
    ],
    abilities: [],
    equipment: "Funda, lança, pedras x20.",
    treasure: "Metade.",
...
export const koboldXama = {
    ...
    stats: {
        initiative: 5, perception: 6, defense: 20, fortitude: 3, reflex: 9, will: 15,
        hitPoints: 69,
        speedText: "9m (6q)",
        senses: null,
        defensesText: null,
        attributes: { str: 0, dex: 2, con: 1, int: -1, wis: 3, cha: -1 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Gadanho +12 (2d4+3, x4) e mordida +12 (1d4+3)." },
        { name: "À Distância", text: "Funda +12 (1d6+3)." }
    ],
    abilities: [],
    equipment: "Andrajos, bálsamo restaurador, funda, gadanho, pedras x20, símbolo sagrado de Kallyadra.",
    treasure: "Padrão.",
...
export const cocatrizReal = {
    ...
    stats: {
        initiative: 17, perception: 8, defense: 32, fortitude: 20, reflex: 12, will: 7,
        hitPoints: 250,
        speedText: "6m (4q), voo 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: 2, dex: 7, con: 3, int: -5, wis: 1, cha: -2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Bicada +24 (2d8+12 perfuração) e cauda de." }
    ],
    abilities: [],
    equipment: null,
    treasure: "1 dose de lágrima pétrea (CD 22 para extrair) e 1d4 ovos de cocatriz.",
    skillsText: null
};
...
export const harpiaSaqueadora = {
    ...
    source: { book: "Ameaças de Arton", pdfFile: "ameacas de arton variadas.pdf", pdfPage: 10, bookPage: 200 },
    stats: {
        initiative: 13, perception: 7, defense: 18, fortitude: 10, reflex: 15, will: 5,
        hitPoints: 32,
        speedText: "9m (6q), voo 12m (8q)",
        senses: null,
        defensesText: null,
        attributes: { str: 1, dex: 4, con: 2, int: -1, wis: 3, cha: 2 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Maça +20 (1d8+11) e garra +20 (1d6+11) ou." }
    ],
    abilities: [],
    equipment: "Maça.",
    treasure: "Nenhum.",
...
export const mantor = {
    ...
    stats: {
        initiative: 11, perception: 8, defense: 24, fortitude: 11, reflex: 17, will: 5,
        hitPoints: 200,
        speedText: "voo 18m (12q)",
        senses: null,
        defensesText: null,
        attributes: { str: 4, dex: 5, con: 2, int: -1, wis: 2, cha: 0 }
    },
    actions: [
        { name: "Corpo a Corpo", text: "Aguilhão +17 (1d10+8 perfuração, x3, alcance)." }
    ],
    abilities: [],
    equipment: null,
...
export const quimera = {
    ...
    actions: [
        { name: "Corpo a Corpo", text: "Três mordidas +26 (3d8+7)." },
        { name: "Corpo a Corpo", text: "Duas garras +24 (2d6+10)." }
    ],
    abilities: [
